...
Blockly.Python['yolobit_lora_create'] = function(block) {
    ...
    Blockly.Python.definitions_['lora_e32_init'] = 'e32 = ebyteE32(tx_pin ='+ tx + '.pin,' + 'rx_pin =' + rx +'.pin, debug = False)\n';
    // TODO: Assemble JavaScript into code variable.
    var code = '';
    return code;
};

Blockly.Blocks['yolobit_lora_show'] = {
  init: function() {
    this.jsonInit(
      {
          "type": "start",
...
Blockly.Python['yolobit_lora_show'] = function(block) {
    Blockly.Python.definitions_['import_yolobit'] = 'from yolobit import *';
    Blockly.Python.definitions_['import_machine'] = 'from lora_e32 import ebyteE32';
    Blockly.Python.definitions_['import_utime'] = 'import utime';
    // TODO: Assemble JavaScript into code variable.
...
Blockly.Blocks['yolobit_lora_config'] = {
  init: function() {
    this.jsonInit(
      {
          "type": "start",
...
Blockly.Python['yolobit_lora_config'] = function(block) {
...
Blockly.Blocks['yolobit_lora_send_to'] = {
  init: function() {
      this.jsonInit(
          {
              "type": "yolobit_lora_send_to",
...
Blockly.Python['yolobit_lora_send_to'] = function(block) {
  var message = Blockly.Python.valueToCode(block, 'MESSAGE', Blockly.Python.ORDER_ATOMIC);
